...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\OrderCrudController' => 'getOrderCrudControllerService',
            'App\\Controller\\OrderReviewMakerController' => 'getOrderReviewMakerControllerService',
            ...
            'App\\Controller\\VideoCloudFlareController' => 'getVideoCloudFlareControllerService',
    ...
    protected static function get_Container_Private_ProfilerService($container)
    {
        ...
        $instance->add(new \Symfony\Component\Workflow\DataCollector\WorkflowDataCollector(new RewindableGenerator(function () use ($container) {
            yield 'order_workflow' => ($container->privates['debug.state_machine.order_workflow'] ?? self::getDebug_StateMachine_OrderWorkflowService($container));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('YIe3Q9KesR', 0, ($container->targetDir.''.'/pools/app'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true));
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\SystemLogRepository' => ['privates', 'App\\Repository\\SystemLogRepository', 'getSystemLogRepositoryService', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
            'App\\Repository\\VideoReviewRepository' => ['privates', 'App\\Repository\\VideoReviewRepository', 'getVideoReviewRepositoryService', true],
        ], [
            'App\\Repository\\OrderRepository' => '?',
            'App\\Repository\\ResetPasswordRequestRepository' => '?',
            'App\\Repository\\SystemLogRepository' => '?',
            'App\\Repository\\UserRepository' => '?',
            'App\\Repository\\VideoReviewRepository' => '?',
        ])));
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('workflow.order_workflow.transition.notify', [#[\Closure(name: 'App\\EventListener\\OrderWorkflowSubscriber')] fn () => ($container->privates['App\\EventListener\\OrderWorkflowSubscriber'] ?? $container->load('getOrderWorkflowSubscriberService')), 'onOrderNotify'], 0);
        $instance->addListener('workflow.order_workflow.transition.create', [#[\Closure(name: 'App\\EventListener\\OrderWorkflowSubscriber')] fn () => ($container->privates['App\\EventListener\\OrderWorkflowSubscriber'] ?? $container->load('getOrderWorkflowSubscriberService')), 'onOrderNotify'], 0);
        $instance->addListener('workflow.order_workflow.transition.decline', [#[\Closure(name: 'App\\EventListener\\OrderWorkflowSubscriber')] fn () => ($container->privates['App\\EventListener\\OrderWorkflowSubscriber'] ?? $container->load('getOrderWorkflowSubscriberService')), 'onOrderNotify'], 0);
        $instance->addListener('workflow.order_workflow.transition.revert', [#[\Closure(name: 'App\\EventListener\\OrderWorkflowSubscriber')] fn () => ($container->privates['App\\EventListener\\OrderWorkflowSubscriber'] ?? $container->load('getOrderWorkflowSubscriberService')), 'onOrderNotify'], 0);
        $instance->addListener('system.log', [#[\Closure(name: 'App\\EventListener\\SystemLogSubscriber')] fn () => ($container->privates['App\\EventListener\\SystemLogSubscriber'] ?? $container->load('getSystemLogSubscriberService')), 'onSystemLogEvent'], 0);
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('L0V1dtJHjC', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mwejyuk6et', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JPcwvRwVwG', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDebug_SerializerService($container)
    {
        ...
        return $container->privates['debug.serializer'] = new \Symfony\Component\Serializer\Debug\TraceableSerializer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, translator: NULL), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $d), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($c, $d, $e, $f, NULL)), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), $b), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($c, $d, $a, $e, $f, NULL), $b)], [new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\XmlEncoder(), $b), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL), $b), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), $b), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\CsvEncoder(), $b)]), $b);
    }

    /**
     * Gets the private 'debug.state_machine.order_workflow' shared service.
     *
     * @return \Symfony\Component\Workflow\Debug\TraceableWorkflow
     */
    protected static function getDebug_StateMachine_OrderWorkflowService($container)
    {
        $a = ($container->services['event_dispatcher'] ?? self::getEventDispatcherService($container));

        if (isset($container->privates['debug.state_machine.order_workflow'])) {
            return $container->privates['debug.state_machine.order_workflow'];
        }

        return $container->privates['debug.state_machine.order_workflow'] = new \Symfony\Component\Workflow\Debug\TraceableWorkflow(new \Symfony\Component\Workflow\StateMachine(new \Symfony\Component\Workflow\Definition(['draft', 'pending', 'accepted', 'declined', 'notified', 'published', 'ready', 'hold'], [new \Symfony\Component\Workflow\Transition('create', 'draft', 'pending'), new \Symfony\Component\Workflow\Transition('accept', 'pending', 'accepted'), new \Symfony\Component\Workflow\Transition('decline', 'pending', 'declined'), new \Symfony\Component\Workflow\Transition('notify', 'accepted', 'notified'), new \Symfony\Component\Workflow\Transition('ready', 'notified', 'ready'), new \Symfony\Component\Workflow\Transition('hold', 'draft', 'hold'), new \Symfony\Component\Workflow\Transition('hold', 'pending', 'hold'), new \Symfony\Component\Workflow\Transition('hold', 'accepted', 'hold'), new \Symfony\Component\Workflow\Transition('hold', 'notified', 'hold'), new \Symfony\Component\Workflow\Transition('hold', 'published', 'hold'), new \Symfony\Component\Workflow\Transition('publish', 'notified', 'published'), new \Symfony\Component\Workflow\Transition('revert', 'pending', 'draft'), new \Symfony\Component\Workflow\Transition('revert', 'hold', 'draft')], [], new \Symfony\Component\Workflow\Metadata\InMemoryMetadataStore([], [], new \SplObjectStorage())), new \Symfony\Component\Workflow\MarkingStore\MethodMarkingStore(true, 'status'), $a, 'order_workflow', NULL), ($container->services['debug.stopwatch'] ??= new \Symfony\Component\Stopwatch\Stopwatch(true)));
    }
    ...
    protected static function getTwigService($container)
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\WorkflowExtension(($container->privates['workflow.registry'] ?? self::getWorkflow_RegistryService($container))));
    ...
    protected static function getValidator_BuilderService($container)
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Component\Validator\ContainerConstraintValidatorFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Validator\\Constraints\\ComplexPasswordValidator' => ['privates', 'App\\Validator\\Constraints\\ComplexPasswordValidator', 'getComplexPasswordValidatorService', true],
            ...
            'App\\Validator\\Constraints\\ComplexPasswordValidator' => '?',
    ...
    protected static function getWorkflow_RegistryService($container)
    {
        ...
        $instance->addWorkflow(($container->privates['debug.state_machine.order_workflow'] ?? self::getDebug_StateMachine_OrderWorkflowService($container)), new \Symfony\Component\Workflow\SupportStrategy\InstanceOfSupportStrategy('App\\Entity\\Order'));
    ...
    private $loadedDynamicParameters = [
        ...
        'bunny_cdn.region' => false,
        'bunny_cdn.storage_zone_name' => false,
        'bunny_cdn.access_key' => false,
        'cloudflare.api_key' => false,
        'cloudflare.account_id' => false,
        'kernel.secret' => false,
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'bunny_cdn.region' => $container->getEnv('BUNNYCDN_REGION'),
            'bunny_cdn.storage_zone_name' => $container->getEnv('BUNNYCDN_STORAGE_ZONE_NAME'),
            'bunny_cdn.access_key' => $container->getEnv('BUNNYCDN_ACCESS_KEY'),
            'cloudflare.api_key' => $container->getEnv('CLOUDFLARE_API_KEY'),
            'cloudflare.account_id' => $container->getEnv('CLOUDFLARE_ACCOUNT_ID'),
